...
public class PatientParser {
    ...
    public PatientParser() {
        namesPatientParser = TaggerFactory.getTagger(GrobidMedicalReportModel.NAME_PATIENT);
    }
...
//System.out.println(res);
            TaggingTokenClusteror clusteror = new TaggingTokenClusteror(GrobidMedicalReportModel.NAME_PATIENT, res, tokens);
