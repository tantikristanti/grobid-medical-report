 ...
 *
 */
public class FullMedicalTextTrainerRunner {

    private static final String USAGE = "Usage: {0 - train, 1 - evaluate, 2 - split, train and evaluate} {_full_medical_text} "
    ...
    public static void main(String[] args) {
        ...
        String path2GbdHome = MedicalReportProperties.get("grobid.home");
