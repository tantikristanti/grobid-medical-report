...
import org.grobid.trainer.sax.TEIPatientNameSaxParser;
...
public class NamePatientTrainer extends AbstractTrainer {

    public NamePatientTrainer() {
        super(GrobidModels.NAMES_PATIENT);
    }
    ...
    public int createCRFPPData(final File corpusDir,
        ...
        try {
            ...
            for (; n < refFiles.length; n++) {
                ...
                final TEIPatientNameSaxParser parser2 = new TEIPatientNameSaxParser();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Trainer trainer = new NamePatientTrainer();
