...
//                    previousPreviousLine = previousLine;
    ...
    protected final File getCorpusPath() {
        return new File(MedicalReportProperties.get("grobid.header.medical.report.corpusPath"));
    }

    protected final File getTemplatePath() {
        return new File(MedicalReportProperties.get("grobid.header.medical.report.templatePath"));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        AbstractTrainer.runTraining(new HeaderMedicalReportTrainer());
        System.out.println(AbstractTrainer.runEvaluation(new HeaderMedicalReportTrainer()));
        System.exit(0);*/
