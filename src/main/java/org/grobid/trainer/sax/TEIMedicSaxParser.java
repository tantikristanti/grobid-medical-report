...
/**
 * SAX parser for medics sequences encoded in the TEI format data.
...
public class TEIMedicSaxParser extends DefaultHandler {
    ...
    public void endElement(String uri,
        ...
        if ((
            (qName.equals("persName")) || (qName.equals("affiliation")) || (qName.equals("address"))
        ) & (currentTag != null)) {
            String text = getText();
            writeField(text);
    ...
    public void startElement(String namespaceURI,
        ...
        if (qName.equals("persName")) {
            ...
            !qName.equals("tei") && !qName.equals("medic") &&
            !qName.equals("persName") &&  !qName.equals("affiliation") &&
