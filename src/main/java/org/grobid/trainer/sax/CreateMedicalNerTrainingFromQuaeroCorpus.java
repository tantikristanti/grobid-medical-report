...
public class CreateMedicalNerTrainingFromQuaeroCorpus {
    private static final Logger LOGGER = LoggerFactory.getLogger(CreateMedicalNerTrainingFromQuaeroCorpus.class);

    public void createMedicalNerTraining(String input, String output) {
        try {
    ...
    public void setNestedEntity(List<QuaeroEntity> entities) {
        ...
        /*for (QuaeroEntity entity : entities) {
            System.out.println("entity : " + entity.getText() + "; offSet : " + entity.getOffset() + "; isNested : " + entity.isNestedEntity());
        }*/
    }
